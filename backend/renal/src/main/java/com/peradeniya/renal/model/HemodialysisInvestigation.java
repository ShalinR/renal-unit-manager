...
@Entity
@Table(name = "hemodialysis_investigation")
public class HemodialysisInvestigation {
    ...
    public Long getMonthlyReviewId() {
        return monthlyReviewId;
    }

    public void setMonthlyReviewId(Long monthlyReviewId) {
        this.monthlyReviewId = monthlyReviewId;
    }
