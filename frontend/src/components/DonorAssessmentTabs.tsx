...
const DonorAssessmentTabs: React.FC = () => {
    ...
    return {
        ...
        ? {
            ...
            oral: donor.examination.oral
              ? {
                  ...
                  unsatisfactory:
                    donor.examination.oral.unsatisfactory || false,
                }
              : {
                  dentalCaries: false,
                  oralHygiene: false,
            ...
            respiratory: donor.examination.respiratory
              ? {
                  ...
                  auscultation:
                    donor.examination.respiratory.auscultation || false,
            ...
            neurologicalExam: donor.examination.neurologicalExam
              ? {
                  cranialNerves:
                    donor.examination.neurologicalExam.cranialNerves || false,
                  upperLimb:
                    donor.examination.neurologicalExam.upperLimb || false,
                  lowerLimb:
                    donor.examination.neurologicalExam.lowerLimb || false,
                  coordination:
                    donor.examination.neurologicalExam.coordination || false,
                }
              : {
                  cranialNerves: false,
                  upperLimb: false,
      ...
      immunologicalDetails: donor.immunologicalDetails
        ? {
            ...
            hlaTyping: donor.immunologicalDetails.hlaTyping
              ? {
                  donor: donor.immunologicalDetails.hlaTyping.donor
                    ? {
                        hlaA:
                          donor.immunologicalDetails.hlaTyping.donor.hlaA || "",
                        hlaB:
                          donor.immunologicalDetails.hlaTyping.donor.hlaB || "",
                        hlaC:
                          donor.immunologicalDetails.hlaTyping.donor.hlaC || "",
                        hlaDR:
                          donor.immunologicalDetails.hlaTyping.donor.hlaDR ||
                          "",
                        hlaDP:
                          donor.immunologicalDetails.hlaTyping.donor.hlaDP ||
                          "",
                        hlaDQ:
                          donor.immunologicalDetails.hlaTyping.donor.hlaDQ ||
                          "",
                      }
                    : {
                        hlaA: "",
                  ...
                  recipient: donor.immunologicalDetails.hlaTyping.recipient
                    ? {
                        hlaA:
                          donor.immunologicalDetails.hlaTyping.recipient.hlaA ||
                          "",
                        hlaB:
                          donor.immunologicalDetails.hlaTyping.recipient.hlaB ||
                          "",
                        hlaC:
                          donor.immunologicalDetails.hlaTyping.recipient.hlaC ||
                          "",
                        hlaDR:
                          donor.immunologicalDetails.hlaTyping.recipient
                            .hlaDR || "",
                        hlaDP:
                          donor.immunologicalDetails.hlaTyping.recipient
                            .hlaDP || "",
                  ...
                  conclusion: donor.immunologicalDetails.hlaTyping.conclusion
                    ? {
                        hlaA:
                          donor.immunologicalDetails.hlaTyping.conclusion
                            .hlaA || "",
                        hlaB:
                          donor.immunologicalDetails.hlaTyping.conclusion
                            .hlaB || "",
            ...
            immunologicalRisk:
              donor.immunologicalDetails.immunologicalRisk || "",
          }
        : {
  ...
  const handleDeleteDonor = async (donorId: string, donorName: string) => {
    if (
      window.confirm(`Are you sure you want to delete donor "${donorName}"?`)
    ) {
      try {
        ...
        alert(
          `Failed to delete donor: ${error instanceof Error ? error.message : "Unknown error"}`
        );
      } finally {
  ...
  const availableDonorsCount = donors.filter(
    (donor) => donor.status !== "assigned"
  ).length;
  const assignedDonorsCount = donors.filter(
    (donor) => donor.status === "assigned"
  ).length;
