...
import { Pill, Droplets, Heart, Activity } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Enter medications for PD patients
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button 
              onClick={() => navigate("/medications/pd")} 
              className="w-full"
              variant="default"
            >
              Enter Medications
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Enter medications for HD patients
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button 
              onClick={() => navigate("/medications/hd")} 
              className="w-full"
              variant="default"
            >
              Enter Medications
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Enter medications for transplant patients
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button 
              onClick={() => navigate("/medications/kt")} 
              className="w-full"
              variant="default"
            >
              Enter Medications
