      ...
      <div className="flex min-h-screen w-full bg-slate-50">
        ...
        <main className="flex-1 flex flex-col">
            ...
            <SidebarTrigger className="p-2 border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white rounded-lg transition-colors" />                <div className="flex flex-col">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 pr-4 py-2 w-80 rounded-lg border-slate-200 focus:border-blue-300 focus:ring-2 focus:ring-blue-100 transition-all text-sm"
                    />
                  </div>
                ...
                <div className="flex items-center gap-2">
                  <Button variant="ghost" size="icon" className="rounded-full h-9 w-9 text-slate-600 hover:bg-slate-100 relative">
                  ...
                  <Button variant="ghost" size="icon" className="rounded-full h-9 w-9 text-slate-600 hover:bg-slate-100">
          ...
          <div className="flex-1 p-6 bg-slate-50">
            <div className="max-w-full mx-auto bg-white rounded-xl shadow-sm p-6 border border-slate-100">
              {children}
            </div>
          </div>
        </main>
