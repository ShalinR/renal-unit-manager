...
const KidneyTransplant = () => {
  ...
  const handleDonorFormChange = (field: string, value: any) => {
    ...
    } else if (field.startsWith('immunologicalDetails.')) {
      const parts = field.split('.');
      if (parts.length === 3) {
        const section = parts[1];
        const subField = parts[2];
        setDonorForm(prev => ({
          ...
          immunologicalDetails: {
            ...
            [section]: {
              ...(prev.immunologicalDetails[section as keyof typeof prev.immunologicalDetails] as any),
              [subField]: value,
            },
          },
        }));
        ...
        setDonorForm(prev => ({
          ...
          immunologicalDetails: {
            ...
            [section]: {
              ...(prev.immunologicalDetails[section as keyof typeof prev.immunologicalDetails] as any),
              [subSection]: {
                ...(prev.immunologicalDetails[section as keyof typeof prev.immunologicalDetails] as any)[subSection as keyof any],
                [subField]: value,
              },
            },
          },
        ...
        return (
          <div className="space-y-6">
            ...
            <form onSubmit={handleDonorFormSubmit} className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="bloodGroupD">D</Label>
                        <Input
                          id="bloodGroupD"
                          value={donorForm.immunologicalDetails.bloodGroup.d}
                          onChange={(e) => handleDonorFormChange('immunologicalDetails.bloodGroup.d', e.target.value)}
                          placeholder="Enter D value"
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="bloodGroupR">R</Label>
                        <Input
                          id="bloodGroupR"
                          value={donorForm.immunologicalDetails.bloodGroup.r}
                          onChange={(e) => handleDonorFormChange('immunologicalDetails.bloodGroup.r', e.target.value)}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="tCell">T Cell</Label>
                        <Input
                          id="tCell"
                          value={donorForm.immunologicalDetails.crossMatch.tCell}
                          onChange={(e) => handleDonorFormChange('immunologicalDetails.crossMatch.tCell', e.target.value)}
                          placeholder="Enter T cell value"
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="bCell">B Cell</Label>
                        <Input
                          id="bCell"
                          value={donorForm.immunologicalDetails.crossMatch.bCell}
                          onChange={(e) => handleDonorFormChange('immunologicalDetails.crossMatch.bCell', e.target.value)}
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.donor.hlaA}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.donor.hlaA', e.target.value)}
                            ...
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.donor.hlaB}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.donor.hlaB', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="B"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.donor.hlaC}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.donor.hlaC', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="C"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.donor.hlaDR}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.donor.hlaDR', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DR"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.donor.hlaDP}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.donor.hlaDP', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DP"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.donor.hlaDQ}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.donor.hlaDQ', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DQ"
                              />
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.recipient.hlaA}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.recipient.hlaA', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="A"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.recipient.hlaB}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.recipient.hlaB', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="B"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.recipient.hlaC}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.recipient.hlaC', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="C"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.recipient.hlaDR}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.recipient.hlaDR', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DR"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.recipient.hlaDP}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.recipient.hlaDP', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DP"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.recipient.hlaDQ}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.recipient.hlaDQ', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DQ"
                              />
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.conclusion.hlaA}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.conclusion.hlaA', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="A"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.conclusion.hlaB}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.conclusion.hlaB', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="B"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.conclusion.hlaC}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.conclusion.hlaC', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="C"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.conclusion.hlaDR}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.conclusion.hlaDR', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DR"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.conclusion.hlaDP}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.conclusion.hlaDP', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DP"
                              />
                            </td>
                            <td className="border border-border p-1">
                              <Input
                                value={donorForm.immunologicalDetails.hlaTyping.conclusion.hlaDQ}
                                onChange={(e) => handleDonorFormChange('immunologicalDetails.hlaTyping.conclusion.hlaDQ', e.target.value)}
                                className="border-0 focus:ring-0 h-8"
                                placeholder="DQ"
                              />
                            </td>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="praPre">Pre (%)</Label>
                        <Input
                          id="praPre"
                          value={donorForm.immunologicalDetails.pra.pre}
                          onChange={(e) => handleDonorFormChange('immunologicalDetails.pra.pre', e.target.value)}
                          placeholder="Enter pre PRA percentage"
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="praPost">Post (%)</Label>
                        <Input
                          id="praPost"
                          value={donorForm.immunologicalDetails.pra.post}
                          onChange={(e) => handleDonorFormChange('immunologicalDetails.pra.post', e.target.value)}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="dsa"
                        value={donorForm.immunologicalDetails.dsa}
                        onChange={(e) => handleDonorFormChange('immunologicalDetails.dsa', e.target.value)}
                  ...
                  <div className="space-y-4">
                    ...
                    <RadioGroup
                      value={donorForm.immunologicalDetails.immunologicalRisk}
                      onValueChange={(value) => handleDonorFormChange('immunologicalDetails.immunologicalRisk', value)}
                      className="flex gap-6"
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="low" id="riskLow" />
                        <Label htmlFor="riskLow">Low</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="average" id="riskAverage" />
                        <Label htmlFor="riskAverage">Average</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="high" id="riskHigh" />
                        <Label htmlFor="riskHigh">High</Label>
                      </div>
                    </RadioGroup>
                  </div>
                </CardContent>
              ...
              {/* Filled By and Confirmation for Donor Assessment */}
              <div className="space-y-4 mt-4">
                <div className="space-y-2">
                  <Label htmlFor="donorFilledBy">Filled By</Label>
                  <Input id="donorFilledBy" placeholder="Enter your name or staff ID" required />
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox id="donorFinalCheck" />
                  <Label htmlFor="donorFinalCheck">I confirm all information provided is accurate</Label>
                </div>
              </div>
